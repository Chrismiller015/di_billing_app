// [SOURCE: apps/api/src/reports/reports.controller.ts]
import { Controller, Get, Post, Body, Param, Res, UsePipes, ValidationPipe, Query, Delete } from "@nestjs/common";
...
export class ReportsController {
  ...
  @Delete(':id/entries')
  clearReportEntries(@Param('id') id: string) {
    return this.svc.clearReportEntries(id);
  }
